...
class AccessRule extends Component
{
    ...
    public $controllers;
    /**
     * @var array list of positions that this rule applies to (requires properly configured User component).
     * Two special positions are recognized, and they are checked via [[User::isGuest]]:
     *
     ...
     *
     * If this property is not set or empty, it means this rule applies regardless of positions.
     * @see $permissions
     * @see $roleParams
     */
    public $roles;
    ...
    protected function matchRole($user)
    {
        ...
        if ($user === false) {
            throw new InvalidConfigException('The user application component must be available to specify positions in AccessRule.');
        }

...
class DbManager extends BaseManager
{
     ...
     * with the tasks and positions assigned to the user. A param with name 'user' is added to this array,
    ...
    /**
     * {@inheritdoc}
     * The positions returned by this method include the positions assigned via [[$defaultRoles]].
     */
    ...
    /**
     * Returns all permissions that the user inherits from the positions assigned to him.
     * @param string|int $userId the user ID (see [[\yii\web\User::id]])

...
interface ManagerInterface extends CheckAccessInterface
{
     ...
     * @return Role[] all positions in the system. The array is indexed by the role names.
     */
    public function getRoles();

    /**
     * Returns the positions that are assigned to the user via [[assign()]].
     * Note that child positions that are not assigned directly to the user will not be returned.
     * @param string|int $userId the user ID (see [[\yii\web\User::id]])
     * @return Role[] all positions directly assigned to the user. The array is indexed by the role names.
     */
    public function getRolesByUser($userId);

    /**
     * Returns child positions of the role specified. Depth isn't limited.
     * @param string $roleName name of the role to file child positions for
     * @return Role[] Child positions. The array is indexed by the role names.
    ...
    /**
     * Returns the child permissions and/or positions.
     * @param string $name the parent name
     * @return Item[] the child permissions and/or positions
     */
    ...
    /**
     * Revokes all positions from a user.
    ...
    /**
     * Removes all authorization data, including positions, permissions, rules, and assignments.
     */
    ...
    /**
     * Removes all rules.
     * All positions and permissions which have rules will be adjusted accordingly.
     */

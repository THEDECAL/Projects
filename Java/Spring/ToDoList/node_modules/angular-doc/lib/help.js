...
YUI.add('help', function(Y) {
    ...
    */
    var help = [
        ...
        "",
        "Usage: angular-doc <options> <input path>",
        "",
        "Common Options:",
        "  -c, --config, --configfile <filename>  A JSON config file to provide configuration data.",
        "           You can also create a angulardoc.json file and place it",
        "           anywhere under your source tree and AngularDoc will find",
        "           it and use it.",
        ...
        "  -v, --version Show the current AngularDoc version",
